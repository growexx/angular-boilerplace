...
describe('RegisterComponent', () => {
  ...
  it('should called onRegister() and return success', (() => {
    ...
    const req1 = httpTestingController.expectOne(`${environment.apiUrl}users/add`);
  ...
  it('should match password and confirmpassword', (() => {
    component.registerForm.controls['department'].setValue('Marketing, Services');

    component.registerForm.controls['password'].setValue('123456');
    component.registerForm.controls['confirmpassword'].setValue('123456');
    fixture.detectChanges();
    expect(component.registerForm.valid).withContext("invalid password and confirmpassword").toBeFalsy();
    ...
    fixture.detectChanges();
    expect(component.registerForm.valid).withContext("valid password and confirmpassword").toBeTruthy();

    component.registerForm.controls['password'].setValue(null);
    component.registerForm.controls['confirmpassword'].setValue(null);
    expect(component.registerForm.valid).withContext("nulled password and confirmpassword").toBeFalsy();
  }));
  
  it('should validate form fields with validations', (() => {
    component.registerForm.controls['department'].setValue('');
    expect(component.registerForm.valid).withContext('department should be in proper format').toBeFalsy();
    component.registerForm.controls['department'].setValue('Marketing, Services');
    expect(component.registerForm.valid).withContext('department should be in proper format').toBeTruthy();
